...
export class ScreenService {
  ...
  getScreenDetails(): Observable<any> {
    return this.http.get(this.ems_apiUrl + "SalesTrax/GetMiscCodes"); // Adjust the endpoint as needed
  }
  getAppDetails(): Observable<any> {
    debugger
    return this.http.get(this.ems_apiUrl + "SalesTrax/GetApps"); // Adjust the endpoint as needed
  }

  getModulesDetails(): Observable<any> {
    return this.http.get(this.ems_apiUrl + "SalesTrax/GetModules"); // Adjust the endpoint as needed
  }
  getMatIcons(): Observable<any> {
    return this.http.get(this.ems_apiUrl + "SalesTrax/GetIcons"); // Adjust the endpoint as needed
  }
  ...
  postModuleDetails(moduleModel: any): Observable<any> {
    return this.http.post(this.ems_apiUrl + "SalesTrax/AddModules", moduleModel); // Adjust the endpoint as needed
  }
  //lov's
